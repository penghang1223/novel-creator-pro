...
```
场景1-5的种子词：
[角色标识符:萨拉] ... 穿着白色西装套装 (服装A)

场景6-10的种子词：
[角色标识符:萨拉] ... 穿着酒红色连衣裙 (服装B),
同之前场景的同一角色, 仅更换服装
```
...
镜头1-1：[场景标识符:咖啡厅] 大远景 从入口...
镜头1-2：[场景标识符:咖啡厅] 同一地点, 现在从吧台拍摄...
镜头1-3：[场景标识符:咖啡厅] 同一地点, 反向角度...
```
